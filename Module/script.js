document.addEventListener("DOMContentLoaded", () => {
  ...
  function setGreeting() {
    ...
    const psychQuotes = [
      ...
      "You don't have to solve your entire life tonight. Just focus on one thing, one breath, one moment at a time.",
    ...
    const islamicQuotes = [
      "Do not explain yourself to anyone. Because the one who likes you will not need it, and the one who dislikes you will not believe it. - Ali bin Abi Talib",
      ...
      "A moment of patience in a moment of anger prevents a thousand moments of regret. - Ali bin Abi Talib",
